...
# Anomalize ships with a data set called tidyverse_cran_downloads that contains the daily CRAN download counts 
...
# i. STL: Seasonal Decomposition of Time series by Loess - good for long term trend
# ii. Twitter: Seasonal Decomposition of Time series by Median - works well if seasonal component is more dominant
